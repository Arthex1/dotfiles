...
local wcontainer = require("yoru-menu.container")
local beautiful = require("beautiful")
local animation = require("yoru-menu.animation")
...
function elevated_button.state(args)
	...
	args.hover_bg = args.hover_bg or '#ff555' or helpers.color.button_color(args.normal_bg, 0.1)
...
function elevated_button.normal(args)
	...
	args.hover_bg = args.hover_bg or '#3b4252' --or helpers.color.button_color(args.normal_bg, 0.1)
	args.press_bg = args.press_bg  or helpers.color.button_color(args.normal_bg, 0.2)
