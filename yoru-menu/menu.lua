...
local welevated = require("yoru-menu.buttons.elevated")
local twidget = require("yoru-menu.text")
local beautiful = require("beautiful")
local helpers = require("yoru-menu.helpers")
...
function menu.menu(widgets, width, bg)
	...
	local widget = awful.popup({
		...
		bg = bg or beautiful.main_menu_bg,
		opacity = 1,
...
function menu.sub_menu_button(args)
	...
	args.icon_size = args.icon_size or 8
	args.text = args.text or ""
	args.text_size = args.text_size or 8
	...
	local widget = welevated.state({
		...
		normal_shape = helpers.ui.rrect(8),
...
function menu.button(args)
	args = args or {}
	args.fg = args.fg or beautiful.main_menu_bg
	args.icon = args.icon or nil
	...
	return welevated.normal({
		...
		margins = dpi(5),
		halign = "left",
		normal_bg = args.bg or beautiful.main_menu_bg,
		normal_shape = helpers.ui.rrect(16 / 2),
